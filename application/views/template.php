      ...
      <div class="wrapper">
        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree" class = "collapse">
              ...
              <li><a href="<?php echo base_url().'revendedora/add/';?>"><i class="fa fa-circle-o"></i>Revendedora</a></li>
                  <li><a href="<?php echo base_url().'campanha/add/';?>"><i class="fa fa-circle-o"></i>Campanha</a></li>
                  <li><a href="<?php echo base_url().'produto/add/';?>"><i class="fa fa-circle-o"></i>Produto</a></li>
                  <li><a href="<?php echo base_url().'kit/add/';?>"><i class="fa fa-circle-o"></i>Kit</a></li>
                  <li><a href="<?php echo base_url().'praca/add/';?>"><i class="fa fa-circle-o"></i>Praça</a></li>
                  <li><a href="<?php echo base_url().'vendedor/add/';?>"><i class="fa fa-circle-o"></i>Vendedor</a></li>
                  <li><a href="<?php echo base_url().'admin/add/';?>"><i class="fa fa-circle-o"></i>Administrador</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
        ...
        <aside class="control-sidebar control-sidebar-dark">
          ...
          <div class="tab-content">
            ...
            <!-- /.tab-pane -->
            <!-- Stats tab content -->
            <data></data>iv class="tab-pane" id="control-sidebar-stats-tab">Stats Tab Content</div>
            <!-- /.tab-pane -->
