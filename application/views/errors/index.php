...
<head>
  ...
  <link rel="stylesheet" href="../../sassets/css/bootstrap3-wysihtml5.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" class = "collapse">
        ...
        <li><a href="revendedora/cadastrar"><i class="fa fa-circle-o"></i>Revendedora</a></li>
            <li><a href="<php echo base_url();?>campanha/cadastrar"><i class="fa fa-circle-o"></i>Campanha</a></li>
            <li><a href="produto/cadastrar"><i class="fa fa-circle-o"></i>Produto</a></li>
