...
CREATE TABLE IF NOT EXISTS `cidade` (
  ...
  KEY `fk_cidade_estado1_idx` (`estado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `endereco` (
  ...
  `estado` int(11) NOT NULL,
  PRIMARY KEY (`idEndereco`,`cidade`,`estado`),
  KEY `fk_endereco_cidade1_idx` (`cidade`,`estado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `fk_cidade_estado1` FOREIGN KEY (`estado`) REFERENCES `estado` (`idEstado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `endereco`
--
ALTER TABLE `endereco`
  ADD CONSTRAINT `fk_endereco_cidade1` FOREIGN KEY (`cidade`,`estado`) REFERENCES `cidade` (`idCidade`, `estado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
